...
\section{ボタン効果}
\subsection{startボタン}
 \begin{lstlisting}[caption={startボタン},label={startbuttom_html},breaklines=true,breakatwhitespace=false]
</div>
...
\subsection{resetボタン}
 \begin{lstlisting}[caption={resetボタン},label={resetbuttom_html},breaklines=true,breakatwhitespace=false]
</div>
